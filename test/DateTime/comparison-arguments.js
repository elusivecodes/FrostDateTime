...
describe('DateTime Comparison Argument Tests', function() {
    ...
    describe('#isAfter', function() {
        ...
        it('works with timezones', function() {
            const date1 = new DateTime([2018, 0, 1, 0, 0, 0, 0], 'UTC');
            const date2 = new DateTime([2018, 0, 1, 0, 0, 0, 0], 'Australia/Brisbane');
            assert.equal(
                date1.isAfter(date2),
                true
            );
    ...
    describe('#isBefore', function() {
        ...
        it('works with timestamp', function() {
            const date = new DateTime([2017, 11, 31, 23, 59, 59], 'UTC');
        ...
        it('works with Date', function() {
            const date1 = new DateTime([2017, 11, 31, 23, 59, 59], 'UTC');
        ...
        it('works with timezones', function() {
            const date1 = new DateTime([2017, 11, 31, 23, 59, 59], 'Australia/Brisbane');
            const date2 = new DateTime([2017, 11, 31, 23, 59, 59], 'UTC');
            assert.equal(
                date1.isBefore(date2),
                true
    ...
    describe('#isBetween', function() {
        ...
        it('works with timezones', function() {
            const date1 = new DateTime([2018, 0, 1, 0, 0, 0, 0], 'UTC');
            const date2 = new DateTime([2018, 0, 1, 0, 0, 0, 0], 'Australia/Brisbane');
            const date3 = new DateTime([2018, 0, 1, 0, 0, 0, 0], 'America/New_York');
            assert.equal(
                date1.isBetween(date2, date3),
                true
            );
    ...
    describe('#isSame', function() {
        ...
        it('works with timestamp', function() {
            const date = new DateTime([2018, 0, 1, 0, 0, 0], 'UTC');
            const timestamp = 1514764800000;
            assert.equal(
        ...
        it('works with timezones', function() {
            const date1 = new DateTime([2018, 0, 1, 10, 0, 0], 'Australia/Brisbane');
