...
describe('DateTime Comparisons', function() {
    ...
    describe('#isAfter', function() {
        it('returns false for dates after', function() {
            const date1 = new DateTime([2018, 0, 1, 1, 1, 1]);
            const date2 = new DateTime([2018, 0, 1, 1, 2, 2]);
            assert.equal(
                date1.isAfter(date2),
                false
            );
        ...
        it('returns true for dates before', function() {
            const date1 = new DateTime([2018, 0, 1, 1, 2, 2]);
            const date2 = new DateTime([2018, 0, 1, 1, 1, 1]);
            assert.equal(
                date1.isAfter(date2),
                true
            );
        ...
        it('works with dates after in year scope', function() {
            const date1 = new DateTime([2018, 0]);
            const date2 = new DateTime([2019, 1]);
            assert.equal(
        ...
        it('works with dates before in year scope', function() {
            const date1 = new DateTime([2019, 1]);
            const date2 = new DateTime([2018, 0]);
            assert.equal(
                date1.isAfter(date2, 'year'),
                true
            );
        ...
        it('works with dates after in month scope', function() {
            const date1 = new DateTime([2018, 0, 1]);
            const date2 = new DateTime([2018, 1, 2]);
            assert.equal(
        ...
        it('works with dates before in month scope', function() {
            const date1 = new DateTime([2018, 1, 2]);
            const date2 = new DateTime([2018, 0, 1]);
            assert.equal(
                date1.isAfter(date2, 'month'),
                true
            );
        ...
        it('works with dates after in day scope', function() {
            const date1 = new DateTime([2018, 0, 1, 1]);
            const date2 = new DateTime([2018, 0, 2, 2]);
            assert.equal(
        ...
        it('works with dates before in day scope', function() {
            const date1 = new DateTime([2018, 0, 2, 2]);
            const date2 = new DateTime([2018, 0, 1, 1]);
            assert.equal(
                date1.isAfter(date2, 'day'),
                true
            );
        ...
        it('works with dates after in hour scope', function() {
            const date1 = new DateTime([2018, 0, 1, 1, 1]);
            const date2 = new DateTime([2018, 0, 1, 2, 2]);
            assert.equal(
        ...
        it('works with dates before in hour scope', function() {
            const date1 = new DateTime([2018, 0, 1, 2, 2]);
            const date2 = new DateTime([2018, 0, 1, 1, 1]);
            assert.equal(
                date1.isAfter(date2, 'hour'),
                true
            );
    ...
    describe('#isBetween', function() {
        it('returns true if dates are before and after', function() {
            const date1 = new DateTime([2018, 0, 1, 1, 1, 3]);
            const date2 = new DateTime([2018, 0, 1, 1, 1, 2]);
            const date3 = new DateTime([2018, 0, 1, 1, 1, 4]);
            assert.equal(
        ...
        it('returns false if both dates are before', function() {
            const date1 = new DateTime([2018, 0, 1, 1, 1, 5]);
            const date2 = new DateTime([2018, 0, 1, 1, 1, 2]);
            const date3 = new DateTime([2018, 0, 1, 1, 1, 4]);
            assert.equal(
                date1.isBetween(date2, date3),
        ...
        it('works with dates before and after in year scope', function() {
            const date1 = new DateTime([2019]);
            const date2 = new DateTime([2018]);
            const date3 = new DateTime([2020]);
            assert.equal(
        ...
        it('works with dates before and after in month scope', function() {
            const date1 = new DateTime([2018, 2]);
            const date2 = new DateTime([2018, 1]);
            const date3 = new DateTime([2018, 3]);
            assert.equal(
        ...
        it('works with both dates before in month scope', function() {
            const date1 = new DateTime([2018, 4]);
            const date2 = new DateTime([2018, 1]);
            const date3 = new DateTime([2018, 3]);
            assert.equal(
                date1.isBetween(date2, date3, 'month'),
        ...
        it('works with dates before and after in day scope', function() {
            const date1 = new DateTime([2018, 0, 3]);
            const date2 = new DateTime([2018, 0, 2]);
            const date3 = new DateTime([2018, 0, 4]);
            assert.equal(
        ...
        it('works with both dates before in day scope', function() {
            const date1 = new DateTime([2018, 0, 5]);
            const date2 = new DateTime([2018, 0, 2]);
            const date3 = new DateTime([2018, 0, 4]);
            assert.equal(
                date1.isBetween(date2, date3, 'day'),
        ...
        it('works with dates before and after in hour scope', function() {
            const date1 = new DateTime([2018, 0, 1, 3]);
            const date2 = new DateTime([2018, 0, 1, 2]);
            const date3 = new DateTime([2018, 0, 1, 4]);
            assert.equal(
        ...
        it('works with both dates before in hour scope', function() {
            const date1 = new DateTime([2018, 0, 1, 5]);
            const date2 = new DateTime([2018, 0, 1, 2]);
            const date3 = new DateTime([2018, 0, 1, 4]);
            assert.equal(
                date1.isBetween(date2, date3, 'hour'),
        ...
        it('works with dates before and after in minute scope', function() {
            const date1 = new DateTime([2018, 0, 1, 1, 3]);
            const date2 = new DateTime([2018, 0, 1, 1, 2]);
            const date3 = new DateTime([2018, 0, 1, 1, 4]);
            assert.equal(
        ...
        it('works with both dates before in minute scope', function() {
            const date1 = new DateTime([2018, 0, 1, 1, 5]);
            const date2 = new DateTime([2018, 0, 1, 1, 2]);
            const date3 = new DateTime([2018, 0, 1, 1, 4]);
            assert.equal(
                date1.isBetween(date2, date3, 'minute'),
    ...
    describe('#isSame', function() {
        ...
        it('returns false for dates before', function() {
            const date1 = new DateTime([2018, 0, 1, 1, 1, 2]);
            const date2 = new DateTime([2018, 0, 1, 1, 1, 1]);
            assert.equal(
                date1.isSame(date2),
                false
        ...
        it('works with same dates in year scope', function() {
            const date1 = new DateTime([2018, 1]);
            const date2 = new DateTime([2018, 0]);
            assert.equal(
        ...
        it('works with dates after in year scope', function() {
            const date1 = new DateTime([2018, 1]);
            const date2 = new DateTime([2019, 0]);
            assert.equal(
                date1.isSame(date2, 'year'),
                false
            );
        ...
        it('works with dates before in year scope', function() {
            const date1 = new DateTime([2018, 1]);
            const date2 = new DateTime([2017, 0]);
            assert.equal(
                date1.isSame(date2, 'year'),
                false
            );
        ...
        it('works with same dates in month scope', function() {
            const date1 = new DateTime([2018, 0, 2]);
            const date2 = new DateTime([2018, 0, 1]);
            assert.equal(
        ...
        it('works with dates after in month scope', function() {
            const date1 = new DateTime([2018, 0, 2]);
            const date2 = new DateTime([2018, 1, 1]);
            assert.equal(
                date1.isSame(date2, 'month'),
                false
            );
        ...
        it('works with same dates in day scope', function() {
            const date1 = new DateTime([2018, 0, 1, 2]);
            const date2 = new DateTime([2018, 0, 1, 1]);
            assert.equal(
        ...
        it('works with dates after in day scope', function() {
            const date1 = new DateTime([2018, 0, 1, 2]);
            const date2 = new DateTime([2018, 0, 2, 1]);
            assert.equal(
                date1.isSame(date2, 'day'),
                false
            );
        ...
        it('works with same dates in hour scope', function() {
            const date1 = new DateTime([2018, 0, 1, 1, 2]);
            const date2 = new DateTime([2018, 0, 1, 1, 1]);
            assert.equal(
        ...
        it('works with dates after in hour scope', function() {
            const date1 = new DateTime([2018, 0, 1, 1, 2]);
            const date2 = new DateTime([2018, 0, 1, 2, 1]);
            assert.equal(
                date1.isSame(date2, 'hour'),
                false
            );
        ...
        it('works with dates after in minute scope', function() {
            const date1 = new DateTime([2018, 0, 1, 1, 1, 2]);
            const date2 = new DateTime([2018, 0, 1, 1, 2, 1]);
            assert.equal(
                date1.isSame(date2, 'minute'),
                false
            );
    ...
    describe('#isSameOrAfter', function() {
        ...
        it('works with dates after in year scope', function() {
            const date1 = new DateTime([2019, 1]);
            const date2 = new DateTime([2020, 0]);
            assert.equal(
                date1.isSameOrAfter(date2, 'year'),
                false
            );
