...
describe('DateTimeImmutable #constructor', function() {
    ...
    describe('Date Argument', function() {
        it('uses the Date timestamp', function() {
            ...
            assert.equal(
                new DateTimeImmutable(date, 'UTC')
                    .toISOString(),
                '2019-01-01T00:00:00.0+00:00'
            );
        });
    ...
    describe('DateTimeImmutable Argument', function() {
        it('uses the DateTimeImmutable timestamp', function() {
            const date1 = new DateTimeImmutable(1546300800000, 'UTC');
            const date2 = new DateTimeImmutable(date1, 'UTC');
            assert.equal(
                date1.toISOString(),
                '2019-01-01T00:00:00.0+00:00'
            );
        ...
        it('uses the DateTimeImmutable time zone', function() {
            const date1 = new DateTimeImmutable(1546300800000, 'Australia/Brisbane');
            const date2 = new DateTimeImmutable(date1);
            assert.equal(
                date1.toISOString(),
        ...
        it('allows modifying the DateTimeImmutable time zone', function() {
            const date1 = new DateTimeImmutable(1546300800000, 'UTC');
            const date2 = new DateTimeImmutable(date1, 'Australia/Brisbane');
            assert.equal(
                date1.toISOString(),
                '2019-01-01T00:00:00.0+00:00'
            );
    ...
    describe('Date Array Argument', function() {
        ...
        it('works with month', function() {
            assert.equal(
                new DateTimeImmutable([2019, 1], 'UTC')
                    .toISOString(),
        ...
        it('works with hour', function() {
            assert.equal(
                new DateTimeImmutable([2019, 0, 1, 1], 'UTC')
                    .toISOString(),
        ...
        it('works with minute', function() {
            assert.equal(
                new DateTimeImmutable([2019, 0, 1, 0, 1], 'UTC')
                    .toISOString(),
        ...
        it('works with second', function() {
            assert.equal(
                new DateTimeImmutable([2019, 0, 1, 0, 0, 1], 'UTC')
                    .toISOString(),
        ...
        it('works with millisecond', function() {
            assert.equal(
                new DateTimeImmutable([2019, 0, 1, 0, 0, 0, 1], 'UTC')
                    .toISOString(),
    ...
    describe('Time Zone Argument', function() {
        it('uses the provided time zone', function() {
            assert.equal(
                new DateTimeImmutable(1546300800000, 'Australia/Brisbane')
                    .toISOString(),
                '2019-01-01T10:00:00.0+10:00'
            );
        });
        ...
        it('works with abbreviation', function() {
            assert.equal(
                new DateTimeImmutable(1546300800000, 'AEST')
                    .toISOString(),
                '2019-01-01T10:00:00.0+10:00'
            );
        });
        ...
        it('works with offsets with colon', function() {
            assert.equal(
                new DateTimeImmutable(1546300800000, '+10:00')
                    .toISOString(),
                '2019-01-01T10:00:00.0+10:00'
            );
        });
        ...
        it('works with offsets without colon', function() {
            assert.equal(
                new DateTimeImmutable(1546300800000, '+1000')
                    .toISOString(),
                '2019-01-01T10:00:00.0+10:00'
            );
        });
