...
describe('DateTimeImmutable #humanDiff (Locale)', function() {
    ...
    it('returns the difference in human readable form (weeks)', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 1, 1], { locale: 'ru' })
                .humanDiff(
                    DateTimeImmutable.fromArray([2018, 1, 23])
                ),
            '3 недели назад'
        )
    });
    ...
    it('returns the difference in human readable form (days)', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 1, 1], { locale: 'ru' })
                .humanDiff(
                    DateTimeImmutable.fromArray([2018, 1, 4])
                ),
            '3 дня назад'
        )
    });
    ...
    it('works with year (negative)', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2017], { locale: 'ru' })
                .humanDiff(
    ...
    it('works with years (negative)', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2016], { locale: 'ru' })
                .humanDiff(
                    DateTimeImmutable.fromArray([2018]),
                    'years'
                ),
    ...
    it('works with months', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 9], { locale: 'ru' })
                .humanDiff(
                    DateTimeImmutable.fromArray([2018, 6]),
                    'months'
                ),
    ...
    it('works with month (negative)', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 6], { locale: 'ru' })
                .humanDiff(
    ...
    it('works with week', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 6, 23], { locale: 'ru' })
                .humanDiff(
    ...
    it('works with week (negative)', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 6, 16], { locale: 'ru' })
                .humanDiff(
    ...
    it('works with weeks (negative)', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 5, 15], { locale: 'ru' })
                .humanDiff(
                    DateTimeImmutable.fromArray([2018, 6, 23]),
                    'weeks'
                ),
    ...
    it('works with weeks (relative)', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 1, 8], { locale: 'ru' })
                .humanDiff(
    ...
    it('works with day (negative)', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 6, 22], { locale: 'ru' })
                .humanDiff(
                    DateTimeImmutable.fromArray([2018, 6, 23]),
                    'day'
                ),
    ...
    it('works with days (negative)', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 6, 15], { locale: 'ru' })
                .humanDiff(
                    DateTimeImmutable.fromArray([2018, 6, 23]),
                    'days'
                ),
    ...
    it('works with hour', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 6, 15, 23], { locale: 'ru' })
                .humanDiff(
    ...
    it('works with hour (negative)', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 6, 15, 22], { locale: 'ru' })
                .humanDiff(
    ...
    it('works with hours (negative)', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 6, 15, 12], { locale: 'ru' })
                .humanDiff(
                    DateTimeImmutable.fromArray([2018, 6, 15, 23]),
                    'hours'
                ),
    ...
    it('works with hours and days', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 6, 18, 23], { locale: 'ru' })
                .humanDiff(
                    DateTimeImmutable.fromArray([2018, 6, 15, 12]),
                    'hours'
                ),
    ...
    it('works with minute', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 6, 15, 12, 30], { locale: 'ru' })
                .humanDiff(
    ...
    it('works with minute (negative)', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 6, 15, 12, 29], { locale: 'ru' })
                .humanDiff(
    ...
    it('works with minutes (negative)', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 6, 15, 12, 15], { locale: 'ru' })
                .humanDiff(
                    DateTimeImmutable.fromArray([2018, 6, 15, 12, 30]),
                    'minutes'
                ),
    ...
    it('works with second (negative)', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 6, 15, 12, 30, 29], { locale: 'ru' })
                .humanDiff(
    ...
    it('works with seconds (negative)', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 6, 15, 12, 30, 15], { locale: 'ru' })
                .humanDiff(
                    DateTimeImmutable.fromArray([2018, 6, 15, 12, 30, 30]),
                    'seconds'
                ),
    ...
    it('works with seconds and minutes', function() {
        assert.strictEqual(
            DateTimeImmutable.fromArray([2018, 6, 15, 12, 50, 30], { locale: 'ru' })
                .humanDiff(
                    DateTimeImmutable.fromArray([2018, 6, 15, 12, 30, 15]),
                    'seconds'
                ),
