...
describe('DateTimeImmutable #format', function() {
    ...
    describe('y - Year (1-digit)', function() {
        ...
        it('outputs absolute year', function() {
            assert.strictEqual(
                DateTimeImmutable.fromArray([-2000])
                    .format('y'),
                '2000'
            );
        });
    ...
    describe('Y - Week Year (1-digit)', function() {
        ...
        it('outputs absolute year', function() {
            assert.strictEqual(
                DateTimeImmutable.fromArray([-2000, 1, 4])
                    .format('Y'),
                '2000'
            );
        });
    ...
    describe('M - Month (1-digit)', function() {
        it('outputs month', function() {
            assert.strictEqual(
                DateTimeImmutable.fromArray([2018, 10])
                    .format('M'),
                '10'
            );
        });
    ...
    describe('d - Day of Month (1-digit)', function() {
        it('outputs the day of the month', function() {
            assert.strictEqual(
                DateTimeImmutable.fromArray([2019, 1, 21])
                    .format('d'),
                '21'
            );
        });
    ...
    describe('m - Minute (1-digit)', function() {
        it('outputs the minute', function() {
            assert.strictEqual(
                DateTimeImmutable.fromArray([2019, 1, 1, 0, 25])
                    .format('m'),
                '25'
            );
        });
    ...
    describe('S - Fractional Second', function() {
        it('outputs the fractional second', function() {
            assert.strictEqual(
                DateTimeImmutable.fromArray([2019, 1, 1, 0, 0, 0, 123])
                    .format('SSS'),
                '123'
            );
        });
    ...
    describe('zzz - Time Zone (Short specific non-location format)', function() {
        ...
        it('works with time zones', function() {
            assert.strictEqual(
                DateTimeImmutable.now({ timeZone: 'America/New_York' })
                    .format('zzz'),
                'EST'
            );
        });
