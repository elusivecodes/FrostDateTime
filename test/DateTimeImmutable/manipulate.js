...
describe('DateTimeImmutable Manipulation', function() {
    ...
    describe('#add', function() {
        it('works with year', function() {
            const date1 = DateTimeImmutable.fromArray([2018]);
    ...
    describe('#startOf', function() {
        it('works with year', function() {
            const date1 = DateTimeImmutable.fromArray([2018, 6, 15, 11, 30, 30, 500]);
        ...
        it('works with quarter', function() {
            const date1 = DateTimeImmutable.fromArray([2018, 8, 15, 11, 30, 30, 500]);
