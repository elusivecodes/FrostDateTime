...
(function (global, factory) {
    ...
    _createClass(DateInterval, [{
      ...
      value: function format(formatString) {
        ...
        return _toConsumableArray(formatString).reduce(function (acc, _char) {
          if (!escaped && _char === '%') {
            escaped = true;
          } else if (!escaped || !_this.constructor._formatData[_char]) {
            acc += _char;
          } else {
            acc += _this.constructor._formatData[_char](_this);
            escaped = false;
          }
      ...
      value: function toString() {
        ...
        while (key = keys.shift()) {
          ...
          var index = Math.abs(this[key]) === 1 ? 0 : 1;
          formats.push(this.constructor.langs[key][index]);
          maxValues--;
        }

        return formats.length ? this.constructor.lang.relative[this.invert ? 'ago' : 'in'].replace('%n', this.format(formats.map(function (f) {
          return _this2.constructor.lang.intervals[f];
        }).join(this.constructor.lang.seperator))) : this.constructor.lang.relative.now;
      }
    }]);
  ...
  Object.assign(DateInterval.prototype, {
     ...
     */
    _parseDateTime: function _parseDateTime(interval) {
      var dateTimeMatch = interval.match(this.constructor._dateTimeRegExp);
     ...
     * @return {Boolean} TRUE if the duration string was parsed, otherwise FALSE.
     */
    _parseISO: function _parseISO(interval) {
      var isoMatch = interval.match(this.constructor._isoRegExp);
  ...
  Object.assign(DateInterval, {
     ...
     * @returns {DateInterval} A new DateInterval object.
     */
    fromString: function fromString(durationString) {
  ...
  function () {
    ...
    function DateTime() {
      ...
      var match = timeZone.match(this.constructor._offsetRegExp);
      ...
      if (this._offset && adjustOffset) {
        ...
        if (this._dynamicTz) {
          this._checkOffset(); // compensate for DST transitions


          if (oldOffset !== this._offset) {
            this._utcDate.setTime(this._utcDate.getTime() - (oldOffset - this._offset) * 60000);
          }
        }
      }
  ...
  DateTime._formatData = {
    ...
    Y: {
      value: 'year',
      regex: function regex(_) {
        return "([".concat(DateTime.lang.numberRegExp, "]{1,4})");
      },
    ...
    y: {
      value: 'year',
      regex: function regex(_) {
        return "([".concat(DateTime.lang.numberRegExp, "]{2})");
      },
      input: function input(value) {
    ...
    F: {
      value: 'month',
      regex: function regex(_) {
        return "(".concat(DateTime.lang.months.full.join('|'), ")");
      },
      input: function input(value) {
        return DateTime.lang.months['full'].indexOf(value);
      },
      output: function output(datetime) {
    ...
    M: {
      value: 'month',
      regex: function regex(_) {
        return "(".concat(DateTime.lang.months["short"].join('|'), ")");
      },
      input: function input(value) {
        return DateTime.lang.months['short'].indexOf(value);
      },
      output: function output(datetime) {
    ...
    n: {
      value: 'month',
      regex: function regex(_) {
        return "([".concat(DateTime.lang.numberRegExp, "]{1,2})");
      },
      input: function input(value) {
        return DateTime._parseNumber(value) - 1;
      },
    ...
    z: {
      regex: function regex(_) {
        return "([".concat(DateTime.lang.numberRegExp, "]{1,3})");
      },
      input: function input(value) {
        return DateTime._parseNumber(value);
      },
    ...
    S: {
      regex: function regex(_) {
        return DateTime.lang.ordinalRegExp;
      },
      output: function output(datetime) {
    ...
    l: {
      value: 'day',
      regex: function regex(_) {
        return "(".concat(DateTime.lang.days.full.join('|'), ")");
      },
      input: function input(value) {
        return DateTime.lang.days.full.indexOf(value);
      },
      output: function output(datetime) {
    ...
    D: {
      value: 'day',
      regex: function regex(_) {
        return "(".concat(DateTime.lang.days["short"].join('|'), ")");
      },
      input: function input(value) {
        return DateTime.lang.days["short"].indexOf(value);
      },
      output: function output(datetime) {
    ...
    a: {
      value: 'dayPeriod',
      regex: function regex(_) {
        return "(".concat(DateTime.lang.dayPeriods.lower.join('|'), ")");
      },
      input: function input(value) {
        return DateTime.lang.dayPeriods.lower.indexOf(value) ? 'pm' : 'am';
      },
      output: function output(datetime) {
        return DateTime.lang.dayPeriods.lower[datetime.getHours() < 12 ? 0 : 1];
      }
    },
    // day period upper
    A: {
      value: 'dayPeriod',
      regex: function regex(_) {
        return "(".concat(DateTime.lang.dayPeriods.upper.join('|'), ")");
      },
      input: function input(value) {
        return DateTime.lang.dayPeriods.upper.indexOf(value) ? 'pm' : 'am';
      },
      output: function output(datetime) {
        return DateTime.lang.dayPeriods.upper[datetime.getHours() < 12 ? 0 : 1];
      }
    },
    // swatch time
    B: {
    ...
    u: {
      value: 'milliseconds',
      regex: function regex(_) {
        return "([".concat(DateTime.lang.numberRegExp, "]{1,6})");
      },
      input: function input(value) {
        return DateTime._parseNumber(value) / 1000;
      },
      output: function output(datetime) {
        return DateTime._formatNumber(Math.floor((datetime.getMilliseconds() + datetime._fraction) * 1000));
      }
    },
    ...
    O: {
      value: 'timeZone',
      regex: function regex(_) {
        return "([\\+\\-][".concat(DateTime.lang.numberRegExp, "]{4})");
      },
      input: function input(value) {
        return value;
      },
      output: function output(datetime) {
        return DateTime._formatOffset(datetime._offset, false);
      }
    },
    // offset colon
    P: {
      value: 'timeZone',
      regex: function regex(_) {
        return "([\\+\\-][".concat(DateTime.lang.numberRegExp, "]{2}\\:[").concat(DateTime.lang.numberRegExp, "]{2})");
      },
      input: function input(value) {
        return value;
      },
      output: function output(datetime) {
        return DateTime._formatOffset(datetime._offset);
      }
    },
    ...
    Z: {
      value: 'offset',
      regex: function regex(_) {
        return "([".concat(DateTime.lang.numberRegExp, "]{1,5})");
      },
      input: function input(value) {
    ...
    U: {
      value: 'timestamp',
      regex: function regex(_) {
        return "([".concat(DateTime.lang.numberRegExp, "]+)");
      },
      input: function input(value) {
        return DateTime._parseNumber(value);
      },
    ...
    '#': {
      regex: function regex(_) {
        return "([".concat(DateTime._seperators.map(function (seperator) {
          return '\\' + seperator;
        }).join(''), "])");
      }
    },
    ...
    '*': {
      regex: function regex(_) {
        return "([^".concat(DateTime._seperators.map(function (seperator) {
          return '\\' + seperator;
        })).concat(DateTime.lang.numberRegExp, "]*)");
      }
    }
  };
  /**
  ...
  Object.assign(DateTime.prototype, {
    ...
    getISODay: function getISODay() {
      return this.constructor._isoDay(this.getDay());
    },
    ...
    getISOWeek: function getISOWeek() {
      var week = this.constructor._isoDate(this.getYear(), this.getMonth(), this.getDate()),
          firstWeek = this.constructor._isoDate(week.getUTCFullYear(), 0, 4);
    ...
    getISOYear: function getISOYear() {
      return this.constructor._isoDate(this.getYear(), this.getMonth(), this.getDate()).getUTCFullYear();
    },
  ...
  Object.assign(DateTime.prototype, {
    ...
    setISOWeek: function setISOWeek(week) {
      ...
      tempDate.setUTCFullYear(this.getISOYear(), 0, 4 + (week - 1) * 7);
      return this._setOffsetTime(tempDate.setUTCDate(tempDate.getUTCDate() - this.constructor._isoDay(tempDate.getUTCDay()) + day));
    },
    ...
    setMonth: function setMonth(month) {
      ...
      if (date === null) {
        ...
        if (this.constructor.clampDates) {
          date = Math.min(date, this.constructor.daysInMonth(this.getYear(), month));
        }
      }
    ...
    setYear: function setYear(year) {
      ...
      if (this.constructor.clampDates && date === null) {
        date = Math.min(this.getDate(), this.constructor.daysInMonth(year, month));
      }
  ...
  Object.assign(DateTime.prototype, {
    ...
    _checkOffset: function _checkOffset() {
      this._offset = this._timeZone === 'UTC' ? 0 : (new Date(this.constructor._utcFormatter.format(this)) - new Date(this._formatter.format(this))) / 60000;
    },
     ...
     */
    _compare: function _compare(other, granularity, callback) {
      var tempDate = new DateTime(other, this._timeZone);

      if (!granularity) {
        var timeDiff = this.getTime() - tempDate.getTime();
      ...
      try {
        for (var _iterator = this.constructor._compareLookup[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          var diff = this[method]() - tempDate[method]();
          var result = callback(diff, preCheck);
    ...
    _getTransition: function _getTransition() {
      ...
      this._transition = this.constructor._timeZones[this._timeZone].find(function (transition) {
  ...
  Object.assign(DateTime.prototype, {
    ...
    endOf: function endOf(timeUnit) {
      ...
      switch (timeUnit) {
        ...
        case 'week':
          return this.setDay(6).setHours(23, 59, 59, 999);

        case 'isoWeek':
          return this.setISODay(7).setHours(23, 59, 59, 999);

        case 'month':
          return this.setDate(this.daysInMonth()).setHours(23, 59, 59, 999);

        case 'quarter':
          var month = this.getQuarter() * 3 - 3;
          return this.setMonth(month, this.constructor.daysInMonth(this.getYear(), month)).setHours(23, 59, 59, 999);

        case 'year':
        default:
          return this.setMonth(11, 31).setHours(23, 59, 59, 999);
      }
    },
     ...
     * @returns {DateTime} The DateTime object.
     */
    startOf: function startOf(timeUnit) {
      timeUnit = timeUnit.toLowerCase();
      ...
      switch (timeUnit) {
        ...
        case 'week':
          return this.setDay(0).setHours(0, 0, 0, 0);

        case 'isoWeek':
          return this.setISODay(0).setHours(0, 0, 0, 0);

        case 'month':
          return this.setDate(1).setHours(0, 0, 0, 0);

        case 'quarter':
          var month = this.getQuarter() * 3 - 3;
          return this.setMonth(month, 1).setHours(0, 0, 0, 0);

        case 'year':
        default:
          return this.setMonth(0, 1).setHours(0, 0, 0, 0);
      }
    },
  ...
  Object.assign(DateTime.prototype, {
    ...
    format: function format(formatString) {
      ...
      return _toConsumableArray(formatString).reduce(function (acc, _char2) {
        if (!escaped && _char2 === '\\') {
          escaped = true;
        } else if (escaped || !_this3.constructor._formatData[_char2] || !_this3.constructor._formatData[_char2].output) {
          acc += _char2;
          escaped = false;
        } else {
          acc += _this3.constructor._formatData[_char2].output(_this3);
        }
    ...
    toLocaleDateString: function toLocaleDateString(locales, options) {
      return this._utcDate.toLocaleDateString(locales || this.constructor.defaultLocale, _objectSpread({
        timeZone: this._timeZone
      }, options));
    },
    ...
    toLocaleString: function toLocaleString(locales, options) {
      return this._utcDate.toLocaleString(locales || this.constructor.defaultLocale, _objectSpread({
        timeZone: this._timeZone
      }, options));
    },
    ...
    toLocaleTimeString: function toLocaleTimeString(locales, options) {
      return this._utcDate.toLocaleTimeString(locales || this.constructor.defaultLocale, _objectSpread({
        timeZone: this._timeZone
      }, options));
    },
  ...
  Object.assign(DateTime.prototype, {
    ...
    dateSuffix: function dateSuffix() {
      return this.constructor.lang.ordinal(this.getDate());
    },
     ...
     */
    diff: function diff() {
      var other = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
     ...
     */
    isAfter: function isAfter(other, granularity) {
      return this._compare(other, granularity, function (diff, preCheck) {
        if (diff > 0) {
          return 1;
        }
     ...
     */
    isBefore: function isBefore(other, granularity) {
      return this._compare(other, granularity, function (diff, preCheck) {
        if (diff < 0) {
          return 1;
        }
     ...
     */
    isBetween: function isBetween(other1, other2, granularity) {
     ...
     */
    isSame: function isSame(other, granularity) {
      return this._compare(other, granularity, function (diff) {
        return diff ? -1 : 0;
      });
    },
     ...
     */
    isSameOrAfter: function isSameOrAfter(other, granularity) {
      return this._compare(other, granularity, function (diff) {
        if (diff > 0) {
          return 1;
        }
     ...
     */
    isSameOrBefore: function isSameOrBefore(other, granularity) {
      return this._compare(other, granularity, function (diff) {
        if (diff < 0) {
          return 1;
        }
  ...
  Object.assign(DateTime, {
     ...
     * @returns {DateTime} A new DateTime object.
     */
    fromFormat: function fromFormat(formatString, dateString) {
      var _this4 = this;
      ...
      var originalDateString = dateString,
        ...
        if (escaped && _char3 === dateString.substring(0, 1)) {
          dateString = dateString.substring(1);
          escaped = false;
          return acc;
        }

        if (_this4._seperators.includes(_char3) && _char3 === dateString.substring(0, 1)) {
          dateString = dateString.substring(1);
          return acc;
        }
        ...
        var regex = _this4._formatData[_char3].regex,
        ...
        if (_this4._formatData[_char3].input) {
          var value = _this4._formatData[_char3].value;
          acc[value] = _this4._formatData[_char3].input(dateMatch[1]);
        }
     ...
     * @returns {DateTime} A new DateTime object.
     */
    fromObject: function fromObject(dateObject) {
      var timeZone = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var currentDate,
          currentDay = null;
      ...
      if (dateObject.timestamp) {
        ...
        if ('dayOfYear' in dateObject && !('month' in dateObject || 'date' in dateObject)) {
          dateObject.month = 0;
      ...
      var date = new this(currentDate, 'timeZone' in dateObject ? dateObject.timeZone : timeZone); // set fraction
  ...
  Object.assign(DateTime, {
    ...
    _formatNumber: function _formatNumber(value, padding) {
      ...
      return this.lang.numbers ? value.replace(/./g, function (match) {
        return _this5.lang.numbers[match];
      }) : value;
    },
     ...
     */
    _formatOffset: function _formatOffset(offset) {
      var useColon = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      var sign = offset > 0 ? '-' : '+';

      var hours = this._formatNumber(Math.abs(offset / 60 | 0), 2);

      var minutes = this._formatNumber(Math.abs(offset % 60), 2);

      var colon = useColon ? ':' : '';
      return "".concat(sign).concat(hours).concat(colon).concat(minutes);
    },
    ...
    _parseNumber: function _parseNumber(value) {
      ...
      if (this.lang.numbers) {
        value = value.replace(/./g, function (match) {
          return _this6.lang.numbers.findIndex(match);
        });
      }
  ...
  Object.assign(DateTime, {
    ...
    dayOfYear: function dayOfYear(year, month, date) {
      ...
      return new Array(month).fill().reduce(function (d, _, i) {
        return d + _this7.daysInMonth(year, i);
      }, date);
    },
  ...
  var zones = {
    ...
    "America/Atikokan": 38,
    "America/Bahia": 39,
    "America/Bahia_Banderas": 40,
    "America/Barbados": 41,
    "America/Belem": 42,
    "America/Belize": 43,
    "America/Blanc-Sablon": 44,
    "America/Boa_Vista": 45,
    "America/Bogota": 46,
    "America/Boise": 47,
    "America/Cambridge_Bay": 48,
    "America/Campo_Grande": 49,
    "America/Cancun": 50,
    "America/Caracas": 51,
    "America/Cayenne": 52,
    "America/Cayman": 53,
    "America/Chicago": 54,
    "America/Chihuahua": 55,
    "America/Costa_Rica": 56,
    "America/Creston": 57,
    "America/Cuiaba": 58,
    "America/Curacao": 36,
    "America/Danmarkshavn": 59,
    "America/Dawson": 60,
    "America/Dawson_Creek": 61,
    "America/Denver": 62,
    "America/Detroit": 63,
    "America/Dominica": 22,
    "America/Edmonton": 64,
    "America/Eirunepe": 65,
    "America/El_Salvador": 66,
    "America/Fort_Nelson": 67,
    ...
    "America/Indiana/Indianapolis": 79,
    "America/Indiana/Knox": 80,
    "America/Indiana/Marengo": 81,
    "America/Indiana/Petersburg": 82,
    "America/Indiana/Tell_City": 83,
    "America/Indiana/Vevay": 84,
    "America/Indiana/Vincennes": 85,
    "America/Indiana/Winamac": 86,
    "America/Inuvik": 87,
    "America/Iqaluit": 88,
    "America/Jamaica": 89,
    "America/Juneau": 90,
    "America/Kentucky/Louisville": 91,
    "America/Kentucky/Monticello": 92,
    "America/Kralendijk": 36,
    "America/La_Paz": 93,
    "America/Lima": 94,
    "America/Los_Angeles": 95,
    "America/Lower_Princes": 36,
    "America/Maceio": 96,
    "America/Managua": 97,
    "America/Manaus": 98,
    "America/Marigot": 22,
    "America/Martinique": 99,
    "America/Matamoros": 100,
    "America/Mazatlan": 78,
    ...
    "America/Moncton": 106,
    "America/Monterrey": 100,
    "America/Montevideo": 107,
    "America/Montserrat": 22,
    "America/Nassau": 108,
    "America/New_York": 109,
    "America/Nipigon": 110,
    "America/Nome": 111,
    "America/Noronha": 112,
    ...
    "America/Ojinaga": 55,
    "America/Panama": 53,
    "America/Pangnirtung": 116,
    "America/Paramaribo": 117,
    "America/Phoenix": 118,
    "America/Port-au-Prince": 119,
    "America/Port_of_Spain": 22,
    "America/Porto_Velho": 120,
    "America/Puerto_Rico": 121,
    "America/Punta_Arenas": 122,
    "America/Rainy_River": 123,
    "America/Rankin_Inlet": 124,
    "America/Recife": 125,
    "America/Regina": 126,
    "America/Resolute": 127,
    "America/Rio_Branco": 128,
    "America/Santarem": 129,
    "America/Santiago": 130,
    "America/Santo_Domingo": 131,
    "America/Sao_Paulo": 132,
    "America/Scoresbysund": 133,
    "America/Sitka": 134,
    "America/St_Barthelemy": 22,
    "America/St_Johns": 135,
    "America/St_Kitts": 22,
    "America/St_Lucia": 22,
    "America/St_Thomas": 22,
    "America/St_Vincent": 22,
    "America/Swift_Current": 136,
    "America/Tegucigalpa": 137,
    "America/Thule": 138,
    "America/Thunder_Bay": 139,
    "America/Tijuana": 140,
    "America/Toronto": 141,
    "America/Tortola": 22,
    "America/Vancouver": 142,
    "America/Whitehorse": 143,
    "America/Winnipeg": 144,
    "America/Yakutat": 145,
    "America/Yellowknife": 146,
    "Antarctica/Casey": 147,
    "Antarctica/Davis": 148,
    "Antarctica/DumontDUrville": 149,
    "Antarctica/Macquarie": 150,
    "Antarctica/Mawson": 151,
    "Antarctica/McMurdo": 152,
    "Antarctica/Palmer": 153,
    "Antarctica/Rothera": 154,
    "Antarctica/Syowa": 155,
    "Antarctica/Troll": 156,
    "Antarctica/Vostok": 157,
    "Arctic/Longyearbyen": 158,
    "Asia/Aden": 159,
    "Asia/Almaty": 160,
    "Asia/Amman": 161,
    "Asia/Anadyr": 162,
    ...
    "Asia/Tokyo": 226,
    "Asia/Tomsk": 227,
    "Asia/Ulaanbaatar": 228,
    "Asia/Urumqi": 229,
    "Asia/Ust-Nera": 230,
    "Asia/Vientiane": 170,
    "Asia/Vladivostok": 231,
    "Asia/Yakutsk": 232,
    "Asia/Yangon": 233,
    "Asia/Yekaterinburg": 234,
    "Asia/Yerevan": 235,
    "Atlantic/Azores": 236,
    "Atlantic/Bermuda": 237,
    "Atlantic/Canary": 238,
    "Atlantic/Cape_Verde": 239,
    "Atlantic/Faroe": 240,
    "Atlantic/Madeira": 241,
    "Atlantic/Reykjavik": 242,
    "Atlantic/South_Georgia": 243,
    "Atlantic/St_Helena": 0,
    "Atlantic/Stanley": 244,
    "Australia/Adelaide": 245,
    "Australia/Brisbane": 246,
    "Australia/Broken_Hill": 247,
    "Australia/Currie": 248,
    "Australia/Darwin": 249,
    "Australia/Eucla": 250,
    "Australia/Hobart": 251,
    "Australia/Lindeman": 252,
    "Australia/Lord_Howe": 253,
    "Australia/Melbourne": 254,
    "Australia/Perth": 255,
    "Australia/Sydney": 256,
    "Europe/Amsterdam": 257,
    "Europe/Andorra": 258,
    "Europe/Astrakhan": 259,
    "Europe/Athens": 260,
    "Europe/Belgrade": 261,
    "Europe/Berlin": 262,
    "Europe/Bratislava": 263,
    "Europe/Brussels": 264,
    "Europe/Bucharest": 265,
    "Europe/Budapest": 266,
    "Europe/Busingen": 267,
    "Europe/Chisinau": 268,
    "Europe/Copenhagen": 269,
    "Europe/Dublin": 270,
    "Europe/Gibraltar": 271,
    "Europe/Guernsey": 272,
    "Europe/Helsinki": 273,
    "Europe/Isle_of_Man": 272,
    "Europe/Istanbul": 274,
    "Europe/Jersey": 272,
    "Europe/Kaliningrad": 275,
    "Europe/Kiev": 276,
    "Europe/Kirov": 277,
    "Europe/Lisbon": 278,
    "Europe/Ljubljana": 261,
    "Europe/London": 272,
    "Europe/Luxembourg": 279,
    "Europe/Madrid": 280,
    "Europe/Malta": 281,
    "Europe/Mariehamn": 273,
    "Europe/Minsk": 282,
    "Europe/Monaco": 283,
    "Europe/Moscow": 284,
    "Europe/Oslo": 158,
    "Europe/Paris": 285,
    "Europe/Podgorica": 261,
    "Europe/Prague": 263,
    "Europe/Riga": 286,
    "Europe/Rome": 287,
    "Europe/Samara": 288,
    "Europe/San_Marino": 287,
    "Europe/Sarajevo": 261,
    "Europe/Saratov": 289,
    "Europe/Simferopol": 290,
    "Europe/Skopje": 261,
    "Europe/Sofia": 291,
    "Europe/Stockholm": 292,
    "Europe/Tallinn": 293,
    "Europe/Tirane": 294,
    "Europe/Ulyanovsk": 295,
    "Europe/Uzhgorod": 296,
    "Europe/Vaduz": 267,
    "Europe/Vatican": 287,
    "Europe/Vienna": 297,
    "Europe/Vilnius": 298,
    "Europe/Volgograd": 299,
    "Europe/Warsaw": 300,
    "Europe/Zagreb": 261,
    "Europe/Zaporozhye": 301,
    "Europe/Zurich": 267,
    "Indian/Antananarivo": 2,
    "Indian/Chagos": 302,
    "Indian/Christmas": 303,
    "Indian/Cocos": 304,
    "Indian/Comoro": 2,
    "Indian/Kerguelen": 305,
    "Indian/Mahe": 306,
    "Indian/Maldives": 307,
    "Indian/Mauritius": 308,
    "Indian/Mayotte": 2,
    "Indian/Reunion": 309,
    "Pacific/Apia": 310,
    "Pacific/Auckland": 152,
    "Pacific/Bougainville": 311,
    "Pacific/Chatham": 312,
    "Pacific/Chuuk": 313,
    "Pacific/Easter": 314,
    "Pacific/Efate": 315,
    "Pacific/Enderbury": 316,
    "Pacific/Fakaofo": 317,
    "Pacific/Fiji": 318,
    "Pacific/Funafuti": 319,
    "Pacific/Galapagos": 320,
    "Pacific/Gambier": 321,
    "Pacific/Guadalcanal": 322,
    "Pacific/Guam": 323,
    "Pacific/Honolulu": 324,
    "Pacific/Kiritimati": 325,
    "Pacific/Kosrae": 326,
    "Pacific/Kwajalein": 327,
    "Pacific/Majuro": 328,
  ...
  var _loop = function _loop(timeZone) {
    var parts = values[zones[timeZone]].split('|'),
        zoneAbbrs = parts.shift().split(';').map(function (a) {
      return abbrs[a];
    }),
    ...
    DateTime._timeZones[timeZone] = transitions.map(function (transition, i) {
      ...
      var end = i == transitions.length - 1 ? Number.MAX_VALUE : transitions[i + 1][0] - 1;
      var abbr = transition[1] && zoneAbbrs[transition[1]];
      var dst = transition[2] && zoneAbbrs[transition[2]];
      return {
        start: start,
        end: end,
        abbr: abbr,
  ...
  for (var abbr in abbrOffsets) {
    var offset = parseInt(abbrOffsets[abbr], 36) / 60;
    DateTime._abbreviations[abbr] = offset ? offset * -1 : 0;
  }
